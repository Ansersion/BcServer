...
(
	...
	cus_sig_unit_lang_id INT UNSIGNED NOT NULL,  	
	
	permission TINYINT UNSIGNED NOT NULL DEFAULT 0,
	min_val SMALLINT NOT NULL DEFAULT 32767, /* 0x7FFF */
	max_val SMALLINT NOT NULL DEFAULT 32767, /* 0x7FFF */
	def_val SMALLINT NOT NULL DEFAULT 0,
