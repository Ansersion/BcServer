...
public class SystemSignalStringDefaultValueEntityInfoHbn implements SignalLanguageInterface {
	private static final Logger logger = LoggerFactory.getLogger(SystemSignalStringDefaultValueEntityInfoHbn.class); 
	private Long id;
