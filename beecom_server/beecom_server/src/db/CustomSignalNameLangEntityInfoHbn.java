 ...
 *
 */
public class CustomSignalNameLangEntityInfoHbn implements SignalLanguageInterface {
	private static final Logger logger = LoggerFactory.getLogger(CustomSignalNameLangEntityInfoHbn.class); 
	private Long id;
