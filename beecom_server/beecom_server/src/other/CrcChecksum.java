...
import bp_packet.BPCrcException;
...
public class CrcChecksum {
     ...
     */
    private CrcChecksum(String strValue) {
     ...
     * <ul>
     *   <li>{@link #CRC16} - <tt>"CRC16"</tt></li>
     *   <li>{@link #CRC32} - <tt>"CRC32"</tt></li>
     * </ul>
     */
    @Override
    ...
    static final CRC32 crc32Instance = new CRC32();
    
    public static long calcCrc32(byte[] data) {
    	crc32Instance.reset();
    	crc32Instance.update(data);
    ...
    public static long calcCrc32(byte[] data, int off, int len) {
    	crc32Instance.reset();
    	crc32Instance.update(data, off, len);
    
    	return crc32Instance.getValue();
    } 
    
    static byte[] crc16TabH = { (byte) 0x00, (byte) 0xC1, (byte) 0x81, (byte) 0x40, (byte) 0x01, (byte) 0xC0, (byte) 0x80, (byte) 0x41, (byte) 0x01, (byte) 0xC0, (byte) 0x80, (byte) 0x41, (byte) 0x00, (byte) 0xC1, (byte) 0x81, (byte) 0x40, (byte) 0x01, (byte) 0xC0, (byte) 0x80, (byte) 0x41, (byte) 0x00, (byte) 0xC1, (byte) 0x81, (byte) 0x40, (byte) 0x00, (byte) 0xC1, (byte) 0x81, (byte) 0x40, (byte) 0x01, (byte) 0xC0, (byte) 0x80, (byte) 0x41, (byte) 0x01, (byte) 0xC0, (byte) 0x80, (byte) 0x41, (byte) 0x00, (byte) 0xC1, (byte) 0x81, (byte) 0x40, (byte) 0x00, (byte) 0xC1, (byte) 0x81, (byte) 0x40, (byte) 0x01, (byte) 0xC0, (byte) 0x80, (byte) 0x41, (byte) 0x00, (byte) 0xC1, (byte) 0x81, (byte) 0x40, (byte) 0x01, (byte) 0xC0, (byte) 0x80, (byte) 0x41, (byte) 0x01, (byte) 0xC0,  
    ...
    public static int calcCrc16(byte[] data, int offset, int len, int preval) {  
        ...
        for (int i = 0; i < len; ++i) {  
            ...
            ucCRCLo = ucCRCHi ^ crc16TabH[iIndex];  
            ucCRCHi = crc16TabL[iIndex];  
        }  
        return ((ucCRCHi & 0x00ff) << 8) | (ucCRCLo & 0x00ff) & 0xffff;  
    }  
    
    public CrcChecksum getCrcType(int type) throws BPCrcException{
    	switch(type) {
    	case 0:
    	case 1:
    	default:
    		throw new BPCrcException("Undefined CRC type");
    	}
    }
